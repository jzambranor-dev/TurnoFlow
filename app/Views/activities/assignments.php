                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <form method="POST" action="<?= BASE_URL ?>/activities/assignments/<?= $asg['id'] ?>/remove"
                                      style="display:inline" onsubmit="return confirm('Quitar este asesor de la actividad?')">
                                    <?= \App\Services\CsrfService::field() ?>
                                    <button type="submit" class="action-btn delete" title="Quitar">
