<?php
/**
 * TurnoFlow - Importar Datos de Break
 * Upload Excel file with break compliance data
 */
...
<div class="import-page">
    ...
    <div class="page-header">
        <div class="header-content">
            <div class="form-breadcrumb" style="margin-bottom:8px;">
                ...
                <a href="<?= BASE_URL ?>/breaks">Breaks</a>
                <svg viewBox="0 0 24 24" style="width:14px;height:14px;fill:var(--corp-gray-400);"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>
                <span>Importar</span>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;flex-wrap:wrap;">
                <div>
                    <h1 class="page-header-title">Importar Datos de Break</h1>
                    <p class="page-header-subtitle">Carga el archivo Excel de excesos de break para cruzar con el planificado</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="import-grid">
        ...
        <div class="data-panel" style="padding:28px;">
            <form action="<?= BASE_URL ?>/breaks/import" method="POST" enctype="multipart/form-data" id="importForm">
                ...
                <div class="form-actions">
                    <a href="<?= BASE_URL ?>/breaks" class="btn-action btn-cancel">Cancelar</a>
    ...
    <div class="results-section">
        ...
        <div class="results-stats">
            <div class="stat-mini accent-green">
                ...
                <div class="stat-content">
                    ...
                    <span class="stat-label">Matcheados</span>
                </div>
            </div>
            <div class="stat-mini accent-red">
                ...
                <div class="stat-content">
                    ...
                    <span class="stat-label">No Matcheados</span>
                </div>
            </div>
        ...
        <!-- Unmatched list -->
        <?php if ($unmatched > 0 && !empty($unmatchedList)): ?>
        <div class="errors-panel" style="margin-top:16px;">
            <button type="button" class="errors-toggle" id="unmatchedToggle" aria-expanded="false" aria-controls="unmatchedList">
                ...
                <span>Ver <?= $unmatched ?> asesor<?= $unmatched !== 1 ? 'es' : '' ?> no matcheado<?= $unmatched !== 1 ? 's' : '' ?></span>
            </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function checkSubmitState() {
        var hasCampaign = campaignSelect && campaignSelect.value !== '';
        submitBtn.disabled = !(hasFile && hasCampaign);
    }

    if (campaignSelect) {
        campaignSelect.addEventListener('change', checkSubmitState);
    }
    ...
    setupToggle('unmatchedToggle', 'unmatchedList');
    setupToggle('errorsToggle', 'errorsList');
});
</script>
SCRIPT;
